...
한 때 개발자들이 java 이외의 언어도 지원하도록 오픈 프로젝트를 진행한 적이 있다.<br>
그러나 지금은 모두 폐기되었다.<br> 
<h3>trimDirectiveWhitespaces</h3>
<p>
...
true이면, 자동으로 출력한다. true가 기본 값이다.<br>
...
<h3>errorPage 속성</h3>
<p>
JSP 페이지를 실행하다가 오류가 발생하면 서블릿 컨테이너에 설정된 페이지가 출력된다.
